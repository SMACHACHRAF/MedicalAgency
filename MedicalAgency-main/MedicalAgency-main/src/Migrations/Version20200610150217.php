...
final class Version20200610150217 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medical_files ADD medical_file_name VARCHAR(255) NOT NULL, ADD upload_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medical_files DROP medical_file_name, DROP upload_at');
