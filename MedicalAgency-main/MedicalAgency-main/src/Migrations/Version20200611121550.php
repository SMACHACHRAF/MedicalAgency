 ...
 */
final class Version20200611121550 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medical_files DROP history_id, DROP info_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE folder_informations (id INT AUTO_INCREMENT NOT NULL, weight INT NOT NULL, size INT NOT NULL, smoking TINYINT(1) NOT NULL, alcoholic TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE medical_files ADD history_id INT NOT NULL, ADD info_id INT NOT NULL');
