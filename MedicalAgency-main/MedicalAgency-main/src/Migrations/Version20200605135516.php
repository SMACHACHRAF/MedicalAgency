 ...
 */
final class Version20200605135516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE file_informations (id INT AUTO_INCREMENT NOT NULL, weight INT NOT NULL, size INT NOT NULL, smoking TINYINT(1) NOT NULL, alcoholic TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
