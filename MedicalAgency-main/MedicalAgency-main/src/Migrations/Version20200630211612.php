 ...
 */
final class Version20200630211612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medical_files DROP is_current_diseases, CHANGE qte_smoking_id qte_smoking_id INT DEFAULT NULL, CHANGE qtealcohol_id qtealcohol_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE current_treatments CHANGE medical_files_id medical_files_id INT DEFAULT NULL, CHANGE treatment_name treatment_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE current_treatments CHANGE medical_files_id medical_files_id INT DEFAULT NULL, CHANGE treatment_name treatment_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE medical_files ADD is_current_diseases TINYINT(1) NOT NULL, CHANGE qte_smoking_id qte_smoking_id INT DEFAULT NULL, CHANGE qtealcohol_id qtealcohol_id INT DEFAULT NULL');
