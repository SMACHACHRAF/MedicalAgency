 ...
 */
final class Version20200719135354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE current_treatments ADD medical_files_id INT DEFAULT NULL, DROP current_disease_id, CHANGE treatment_name treatment_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE current_treatments ADD current_disease_id INT DEFAULT NULL, DROP medical_files_id, CHANGE treatment_name treatment_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
