 ...
 */
final class Version20200702004917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE current_treatments ADD current_disease_id INT DEFAULT NULL, DROP medical_files_id, CHANGE treatment_name treatment_name VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE current_treatments ADD CONSTRAINT FK_95F3077F78E9A33 FOREIGN KEY (current_disease_id) REFERENCES current_disease (id)');
        $this->addSql('CREATE INDEX IDX_95F3077F78E9A33 ON current_treatments (current_disease_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE current_treatments DROP FOREIGN KEY FK_95F3077F78E9A33');
        $this->addSql('DROP INDEX IDX_95F3077F78E9A33 ON current_treatments');
        $this->addSql('ALTER TABLE current_treatments ADD medical_files_id INT DEFAULT NULL, DROP current_disease_id, CHANGE treatment_name treatment_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
