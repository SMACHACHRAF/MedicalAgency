 ...
 */
final class Version20200611114821 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE patient_history (id INT AUTO_INCREMENT NOT NULL, current_disease VARCHAR(255) NOT NULL, current_medications VARCHAR(255) NOT NULL, previous_operations VARCHAR(255) NOT NULL, health VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
